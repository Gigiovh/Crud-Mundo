    ...
    <section class="cards-container">
        <article class="card">
            <img class="card__background"
                src="https://wallpaper.forfun.com/fetch/4b/4b49ebebb437fa2078fb5a3aa080ee58.jpeg" alt="berlim"
                width="1920" height="2193" />
            <div class="card__content | flow">
                <div class="card__content--container | flow">
                    <h2 class="card__title">Berlim</h2>
                    <p class="card__description">
                        Uma metrópole que reinventa o passado com estilo, cheia de arte, liberdade e vida noturna
                        inesquecível.
                    </p>
                </div>
        ...
        <article class="card">
            <img class="card__background"
                ...
                alt="sp" width="1920" height="2193" />
            <div class="card__content | flow">
                <div class="card__content--container | flow">
                    <h2 class="card__title">São Paulo</h2>
                    <p class="card__description">
                        Energia que nunca para, sabores de todo o mundo e cultura em cada esquina da maior cidade do
                        Brasil.
                    </p>
                </div>
        ...
        <article class="card">
            <img class="card__background"
                ...
                alt="Toquio" width="1920" height="2193" />
            <div class="card__content | flow">
                <div class="card__content--container | flow">
                    <h2 class="card__title">Tóquio</h2>
                    <p class="card__description">
                        Um espetáculo de luzes, tradição e inovação, onde o futuro e o encanto japonês caminham lado
                        a
                        lado.
                    </p>
                </div>
